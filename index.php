<?php
    ...
    for($i = 0; $i < count($NamaBulan); $i++) {
        $Arr2D[$i] = [$NamaBulan[$i], $HariLibur[$i]];
    }

    foreach($Arr2D as $Tanggal) {
        echo $Tanggal[0] ." - ". $Tanggal[1] ."<br>";
    }
    echo "<br><br>";
    ...
    echo 'Penjumlahan ('.$angka1.' + '.$angka2.'): '. tambah($angka1, $angka2) .'<br>';
    echo 'Pengurangan ('.$angka1.' - '.$angka2.'): '. kurang($angka1, $angka2) .'<br>';
    echo 'Perkalian ('.$angka1.' * '.$angka2.'): '. kali($angka1, $angka2) .'<br>';
    echo 'Pembagian ('.$angka1.' / '.$angka2.'): '. bagi($angka1, $angka2) .'<br>';
